...
const Checkout = () => {
  ...
  if (shipping === "first-class") {
    ...
    totalWithShipping = total + 10.5;
  } else if (shipping === "express") {
    totalWithShipping = total + 30.0;
  }
        ...
        <div className="order-products">
          ...
          <div className="shipping">
            ...
            <div>
              <div>
                <input
                  onChange={() => setShipping("first-class")}
                  type="radio"
                  name="shipping"
                  id="first-class"
                  value="first-class"
              ...
              <div>
                ...
                <label htmlFor="priority">
                  {" "}
                  Priority | 2-3 business days: $10.50{" "}
                </label>
              </div>
              ...
              <div>
                ...
                <label htmlFor="express">
                  Express | 1-2 business days: $30.00
                </label>
              </div>
            </div>
          </div>
